# Health — Group 1: agent and developer guide
...
- **Theme:** Health.
- **Register:** participant (`group_1_registration`).
- **Follow-up action:** Record a wellbeing check (`group_1_followup`).
...
| Registration questions | `forms/group_1_registration/schema.json` and `ui.json` |
| Follow-up questions | `forms/group_1_followup/schema.json` and `ui.json` |
