...
Register participants, open their details, and select **Record a wellbeing check** to save a linked follow-up. Both forms ask only three questions.
...
- `forms/group_1_registration/`: registration schema and layout.
- `forms/group_1_followup/`: follow-up schema and layout.
...
1. Install the bundle in Formulus/Desktop and register two fictional participants.
2. Close each saved form: the table should update without pressing Refresh. Cancel a third form: no draft should appear.
3. Open the first row, select **Record a wellbeing check**, and save. Its history should update; the second row must not show that follow-up.
